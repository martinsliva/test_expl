...
V případě Česka je pravděpodobnost po testu "jen" 1,46%. Ale je si potřeba uvědomit, že před testem byla ta pravděpodobnost 0.03%, takže test odahdovanou pravděpodobnost zvýšil cca 50x. Pokud je prevalence vysoká, jako v Jižní Africe
...
Poznámka k termínům v grafu (myslel jsem, že si jim vyhnu, ale asi to nejde). *True Positive* se označují ti, kteří mají nemoc a test je takto také označil. *False Positive* se označují ti, kteří jsou zdraví ale mají pozitivní test. *True Negative* s označují zdraví a test jejich nemoc nepotvrdil a nakonec *False Negative* se označují nemocní, u kterých test ale nemoc označil. 
